...
class AutoParamsService:
    ...
    async def compute_optimal_params(
        ...
        content_type: str | None = None,  # "gaming", "talking_head", "vlog", etc.
        segment_score: float | None = None,
        segment_tags: list[str] | None = None,  # Tags from viral scoring
    ) -> dict[str, Any]:
        """
        ...
        if not layout_info:
            ...
            logger.info("[AutoParams] No layout info, using VIRAL PRO defaults")
    ...
    def _detect_content_type(self, tags: list[str]) -> str | None:
    ...
    def _detect_facecam_zone(self, layout_info: dict[str, Any]) -> str | None:
    ...
    def _compute_subtitle_position(
        ...
        TIKTOK_SAFE_ZONES["top_margin"] + 100  # ~250
...
# Singleton instance
_instance: AutoParamsService | None = None
