...
class MLScoringService:
    ...
    @classmethod
    def get_instance(cls, library_path: Optional[Path] = None) -> "MLScoringService":
    ...
    def _train_sync(self) -> Optional[MLModelMetadata]:
...
def get_ml_scoring_service(library_path: Optional[Path] = None) -> MLScoringService:
